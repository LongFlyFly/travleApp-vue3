...
>
    <div class="coupon-info coupon-info-right-dashed">
        <div class="coupon-store">{{item.name}}</div>
        <div class="coupon-price">¥{{item.pprice}}</div>
        <div class="coupon-description">点击购买</div>
    </div>
    <div class="coupon-get">
        <div class="coupon-desc">限时</div>
        <div class="coupon-expiry-date">{{item.startTime}}<br/>{{item.endTime}}</div>
    </div>
</div>
